...
class AddScoreActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener,
    TimePickerDialog.OnTimeSetListener, NumberPicker.OnValueChangeListener {

    private lateinit var playerName_textInput: TextInputLayout
    private lateinit var score_textInput: TextInputLayout
    private lateinit var dateTime_textInput: TextInputLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dateTimePicker.setOnClickListener(View.OnClickListener {
            ...
            var datePickerDialog =
                DatePickerDialog(this@AddScoreActivity, this@AddScoreActivity, year, month, day)
        ...
        fab.setOnClickListener { view ->
            if (isNameValid()) {
                ...
                returnIntent.putExtra(
                    "playerName",
                    playerName_textInput.editText?.text.toString().trim()
                )
    ...
    override fun onDateSet(p0: DatePicker?, p1: Int, p2: Int, p3: Int) {
        ...
        var timePickerDialog = TimePickerDialog(
            this@AddScoreActivity, this@AddScoreActivity, hour, minute, false
        )
    ...
    fun secondsPicker() {
        ...
        okButton.setOnClickListener(View.OnClickListener {
            ...
            val currentDateTimeString = DateFormat.getDateTimeInstance()
                .format(Date(year - 1900, month, day, hour, minute, seconds))
