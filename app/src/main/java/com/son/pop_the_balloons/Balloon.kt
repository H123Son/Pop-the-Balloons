...
import com.example.apj180001asg6.PlayGround
import com.example.apj180001asg6.SquareShape
import com.son.pop_the_balloons.PlayActivity.score.isCheatActivated
...
class Balloon : SquareShape, CircularShape {
    ...
    override fun drawCircularShape(canvas: Canvas?) {
        ...
        canvas?.drawCircle(
            (startX + currentBulloonSize / 2.0).toFloat(),
            (currentY - (currentBulloonSize / 2.0)).toFloat(),
            (currentBulloonSize / 2.0).toFloat(),
            paints
        )
    }
    ...
    override fun drawSquareShape(canvas: Canvas?) {
        ...
        rectangles.set(
            startX,
            currentY - (currentBulloonSize),
            startX + currentBulloonSize,
            currentY
        )
    ...
    private fun DrawShape(canvas: Canvas?) {
        ...
        paints.color = Color.WHITE
        paints.style = Paint.Style.STROKE;

        // This draws a string attached to a balloon
        canvas?.drawArc(
            (startX + currentBulloonSize * 3 / 8).toFloat(),
            currentY.toFloat(),
            (startX + currentBulloonSize * 5 / 8).toFloat(),
            (currentY + currentBulloonSize / 4).toFloat(),
            90.0f,
            180.0f,
            false,
            paints
        ...
        canvas?.drawArc(
            (startX + currentBulloonSize * 3 / 8).toFloat(),
            (currentY + currentBulloonSize / 4 - 0.25).toFloat(),
            (startX + currentBulloonSize * 5 / 8).toFloat(),
            (currentY + currentBulloonSize / 2).toFloat(),
            270.0f,
            180.0f,
            false,
            paints
        ...
        canvas?.drawArc(
            (startX + currentBulloonSize * 3 / 8).toFloat(),
            (currentY + currentBulloonSize / 2 - 0.25).toFloat(),
            (startX + currentBulloonSize * 5 / 8).toFloat(),
            (currentY + currentBulloonSize * 3 / 4).toFloat(),
            90.0f,
            180.0f,
            false,
            paints
        ...
        canvas?.drawArc(
            (startX + currentBulloonSize * 3 / 8).toFloat(),
            (currentY + currentBulloonSize * 3 / 4 - 0.25).toFloat(),
            (startX + currentBulloonSize * 5 / 8).toFloat(),
            (currentY + currentBulloonSize).toFloat(),
            270.0f,
            180.0f,
            false,
            paints
